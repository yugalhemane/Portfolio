  ...
  return (
    <section className="relative pt-10 md:pt-20 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-10 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 left-1/2 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="fade-in-up mt-6" style={{ animationDelay: '0.2s', opacity: 0 }}>
        ...
        <div className="fade-in-up" style={{ animationDelay: '0.3s', opacity: 0 }}>
          <p className="mt-4 text-base md:text-lg text-slate-300 max-w-2xl leading-relaxed">
            Passionate about <span className="text-cyan-400 font-semibold">cybersecurity</span> and{" "}
            <span className="text-cyan-400 font-semibold">developer tooling</span>. I love turning
            ideas into real products, from chatbots and security tools to
            fullstack apps built with React and Node.
          </p>
        </div>

        <div className="fade-in-up mt-8" style={{ animationDelay: '0.4s', opacity: 0 }}>
          <SocialLinks className="mt-5" />
        </div>

        {/* Scroll indicator */}
        <div className="fade-in-up mt-12 flex flex-col items-center gap-2" style={{ animationDelay: '0.5s', opacity: 0 }}>
