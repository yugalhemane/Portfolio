  ...
  return (
    <section id="contact" className="mt-24 scroll-mt-20">
      <div className="flex items-center gap-4 mb-4">
        <h2 className="text-3xl md:text-4xl font-bold text-gradient">Let&apos;s talk</h2>
      ...
      <form
        ...
        className="max-w-md space-y-4 rounded-2xl border border-slate-800/50 bg-slate-900/40 backdrop-blur-sm p-6 hover:border-cyan-400/30 transition-all"
      >
